...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("img/Button quizgame.psd", Reflect.field (AssetType, "binary".toUpperCase ()));
			...
			type.set ("img/Submit.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("img/Joker.jpg", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("img/RideOfSteel.jpg", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("img/SpaceMountain.jpg", "img/SpaceMountain.jpg");
			type.set ("img/SpaceMountain.jpg", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("img/TimeWarp.jpg", "img/TimeWarp.jpg");
			type.set ("img/TimeWarp.jpg", Reflect.field (AssetType, "image".toUpperCase ()));
