...
class DefaultAssetLibrary extends openfl.AssetLibrary {
	...
	public function new() {
		...
		add("img/Boomerang.jpg", IMAGE);
		add("img/coasternews quiz background.jpg", IMAGE);
		add("img/coasternews quiz info.jpg", IMAGE);
		add("img/coasternews quiz.jpg", IMAGE);
		add("img/coasternews quiz2.jpg", IMAGE);
		add("img/Dominator.jpg", IMAGE);
		add("img/exit.png", IMAGE);
		add("img/GateKeeper.jpg", IMAGE);
		add("img/GreatWhite.jpg", IMAGE);
		add("img/KingDaKa.jpg", IMAGE);
		add("img/Scores.png", IMAGE);
		add("img/start.png", IMAGE);
		add("img/Tornado.jpg", IMAGE);
		add("assets/music/gamemusic1.ogg", MUSIC);
		add("assets/music/gamemusic2.ogg", MUSIC);
		add("assets/music/gamemusic3.ogg", MUSIC);
		add("assets/music/menuMusic1.ogg", MUSIC);
		add("assets/music/menuMusic2.ogg", MUSIC);
		add("assets/music/menuMusic3.ogg", MUSIC);
		add("assets/music/scoreMusic1.ogg", MUSIC);
		add("assets/music/scoreMusic2.ogg", MUSIC);
		//
	}
