...
class ApplicationMain {
	...
	private static function preload() {
		...
		loadFile("img/Boomerang.jpg");
		loadFile("img/coasternews quiz background.jpg");
		loadFile("img/coasternews quiz info.jpg");
		loadFile("img/coasternews quiz.jpg");
		loadFile("img/coasternews quiz2.jpg");
		loadFile("img/Dominator.jpg");
		loadFile("img/exit.png");
		loadFile("img/GateKeeper.jpg");
		loadFile("img/GreatWhite.jpg");
		loadFile("img/KingDaKa.jpg");
		loadFile("img/Scores.png");
		loadFile("img/start.png");
		loadFile("img/Tornado.jpg");
		loadSound("assets/music/gamemusic1.ogg");
		loadSound("assets/music/gamemusic2.ogg");
		loadSound("assets/music/gamemusic3.ogg");
		loadSound("assets/music/menuMusic1.ogg");
		loadSound("assets/music/menuMusic2.ogg");
		loadSound("assets/music/menuMusic3.ogg");
		loadSound("assets/music/scoreMusic1.ogg");
		loadSound("assets/music/scoreMusic2.ogg");
